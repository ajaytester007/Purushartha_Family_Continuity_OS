...
Write-Host "== Publishing Purushartha OS to GitHub Wiki v2.5 ==" -ForegroundColor Cyan
...
- [[Graph Explorer UI|101-Graph-Explorer-UI-Graph-Explorer-UI]]
- [[Graph Path Views|102-Graph-Path-Views-Graph-Path-Views]]
- [[Mermaid Graph Export|103-Mermaid-Graph-Export-Mermaid-Graph-Export]]
- [[v2.5 Release Notes|104-Release-Notes-v2.5-Graph-Explorer-UI]]
- [[v2.6 Backlog|105-Backlog-vNext-v2.6-Backlog]]
...
git add .
git commit -m "Publish Wiki from v2.5 pipeline"
