...
Write-Host "== Publishing Purushartha OS to GitHub Wiki v2.1 ==" -ForegroundColor Cyan
...
"86_Release_Notes","87_Backlog_vNext"
)
...
## v2.1 Reports Cockpit

- [[Reports Cockpit|82-Reports-Cockpit-Reports-Cockpit]]
- [[Report Index v2.1|82-Reports-Cockpit-Report-Index-v2-1]]
- [[Report Manifest Model|83-Report-Manifest-Report-Manifest-Model]]
- [[Streamlit Report Workbench|84-Streamlit-Report-Workbench-Streamlit-Report-Workbench]]
- [[Pages Report Cards|85-Pages-Report-Cards-Pages-Report-Cards]]
- [[v2.1 Release Notes|86-Release-Notes-v2.1-Streamlit-Workbench-Reports-Cockpit]]
...
Reports should organize repair, governance, and continuity. They should not become accusations without human review and context.
...
- [[Pages Report Cards|85-Pages-Report-Cards-Pages-Report-Cards]]
- [[v2.1 Release Notes|86-Release-Notes-v2.1-Streamlit-Workbench-Reports-Cockpit]]
- [[v2.2 Backlog|87-Backlog-vNext-v2.2-Backlog]]
...
git add .
git commit -m "Publish Wiki from v2.1 pipeline"
