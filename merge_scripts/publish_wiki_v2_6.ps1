...
Write-Host "== Publishing Purushartha OS to GitHub Wiki v2.6 ==" -ForegroundColor Cyan
...
"94_Release_Notes","95_Backlog_vNext","96_Consent_Ledger_UI","97_Evidence_Governance",
"98_Publication_Approval_Gate","99_Release_Notes","100_Backlog_vNext",
"101_Graph_Explorer_UI","102_Graph_Path_Views","103_Mermaid_Graph_Export","104_Release_Notes",
"105_Backlog_vNext","106_SCD2_State_Editor","107_State_Transition_Audit","108_State_Change_Reports",
"109_Release_Notes","110_Backlog_vNext"
)
...
- [[SCD2 State Editor|106-SCD2-State-Editor-SCD2-State-Editor]]
- [[State Transition Audit|107-State-Transition-Audit-State-Transition-Audit]]
- [[State Change Reports|108-State-Change-Reports-State-Change-Reports]]
- [[v2.6 Release Notes|109-Release-Notes-v2.6-SCD2-State-Editor]]
- [[v2.7 Backlog|110-Backlog-vNext-v2.7-Backlog]]
...
git add .
git commit -m "Publish Wiki from v2.6 pipeline"
