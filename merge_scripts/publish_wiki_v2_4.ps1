...
Write-Host "== Publishing Purushartha OS to GitHub Wiki v2.4 ==" -ForegroundColor Cyan
...
## v2.4 Consent Ledger UI and Evidence Governance

- [[Consent Ledger UI|96-Consent-Ledger-UI-Consent-Ledger-UI]]
- [[Evidence Governance|97-Evidence-Governance-Evidence-Governance]]
- [[Publication Approval Gate|98-Publication-Approval-Gate-Publication-Approval-Gate]]
- [[v2.4 Release Notes|99-Release-Notes-v2.4-Consent-Ledger-UI-and-Evidence-Governance]]
- [[v2.5 Backlog|100-Backlog-vNext-v2.5-Backlog]]
...
git add .
git commit -m "Publish Wiki from v2.4 pipeline"
