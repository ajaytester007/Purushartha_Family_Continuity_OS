...
Write-Host "== Publishing Purushartha OS to GitHub Wiki v1.9 ==" -ForegroundColor Cyan
...
## v1.9 Event Graph and SCD2 Engine

- [[Event Graph Engine|68-Event-Graph-Engine-Event-Graph-Engine]]
- [[SCD2 State Engine|69-SCD2-State-Engine-SCD2-State-Engine]]
- [[Consent-Aware Ingestion Rules|70-Consent-Aware-Ingestion-Consent-Aware-Ingestion-Rules]]
- [[Event Graph Report|71-Graph-Reports-event-graph-report-v1-9]]
- [[Streamlit Graph Upgrade|72-Streamlit-Graph-Upgrade-Streamlit-Graph-Upgrade]]
- [[v1.9 Release Notes|73-Release-Notes-v1.9-Event-Graph-and-SCD2-State-Engine]]
...
Graph edges are explainable relationships, not moral verdicts.
...
- [[Event Graph Report|71-Graph-Reports-event-graph-report-v1-9]]
- [[Streamlit Graph Upgrade|72-Streamlit-Graph-Upgrade-Streamlit-Graph-Upgrade]]
- [[v2.0 Backlog|74-Backlog-vNext-v2.0-Backlog]]
...
git add .
git commit -m "Publish Wiki from v1.9 pipeline"
