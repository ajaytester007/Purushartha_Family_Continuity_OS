...
Write-Host "== Publishing Purushartha OS to GitHub Wiki v2.2 ==" -ForegroundColor Cyan
...
"90_Release_Notes","91_Backlog_vNext"
)
...
## v2.2 Interactive Reports Cockpit and Roadmap

- [[Roadmap to v3.0|88-Roadmap-v3-Roadmap-to-v3]]
- [[Roadmap Index v2.2|88-Roadmap-v3-Roadmap-Index-v2-2]]
- [[Streamlit Reports Cockpit|89-Streamlit-Reports-Cockpit-Streamlit-Reports-Cockpit]]
- [[v2.2 Release Notes|90-Release-Notes-v2.2-Interactive-Reports-Cockpit-and-Roadmap]]
- [[v2.3 Backlog|91-Backlog-vNext-v2.3-Backlog]]
...
git add .
git commit -m "Publish Wiki from v2.2 pipeline"
