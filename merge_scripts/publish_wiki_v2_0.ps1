...
Write-Host "== Publishing Purushartha OS to GitHub Wiki v2.0 ==" -ForegroundColor Cyan
...
## v2.0 Local Relationship Intelligence Workbench

- [[Workbench Architecture|75-Workbench-Architecture-Workbench-Architecture]]
- [[Governance Cockpit|76-Governance-Cockpit-Governance-Cockpit]]
- [[Report Builder|77-Report-Builder-Report-Builder]]
- [[Public Private Modes|78-Public-Private-Modes-Public-Private-Modes]]
- [[Workbench Operating Model|79-Workbench-Operating-Model-Workbench-Operating-Model]]
- [[v2.0 Release Notes|80-Release-Notes-v2.0-Local-Relationship-Intelligence-Workbench]]
...
The workbench is decision support, not a surveillance, diagnosis, or punishment system.
...
- [[Workbench Operating Model|79-Workbench-Operating-Model-Workbench-Operating-Model]]
- [[v2.0 Release Notes|80-Release-Notes-v2.0-Local-Relationship-Intelligence-Workbench]]
- [[v2.1 Backlog|81-Backlog-vNext-v2.1-Backlog]]
...
git add .
git commit -m "Publish Wiki from v2.0 pipeline"
